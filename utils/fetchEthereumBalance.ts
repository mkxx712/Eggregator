...
const web3 = new Web3(new Web3.providers.HttpProvider("https://mainnet.infura.io/v3/" + infura_api));
...
export async function getEthereumBalance() {
  ...
  return [
    { assets: "DAI", amount: DAI_formattedResult },
    { assets: "USDT", amount: USDT_formattedResult },
    { assets: "USDC", amount: USDC_formattedResult },
    { assets: "UNI", amount: UNI_formattedResult },
  ];
}
